      ...
      <div className="flex">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col w-full p-2 float-start">
            ...
            />
            <QuickFilterCombobox
              leftIcon={<SquareUser className="pr-2" />}
              text="Author"
              items={[]}
            />
            <QuickFilterCombobox leftIcon={<Target className="pr-2" />} text="Status" items={[]} />
            <Button variant="ghost" size="sm" className="ml-1 w-full justify-between">

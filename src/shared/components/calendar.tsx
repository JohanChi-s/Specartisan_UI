...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: "tailwind.config.tsflex tailwind.config.tsflex-col sm:tailwind.config.tsflex-row tailwind.config.tsspace-y-4 sm:tailwind.config.tsspace-x-4 sm:tailwind.config.tsspace-y-0",
        month: "tailwind.config.tsspace-y-4",
        caption: "tailwind.config.tsflex tailwind.config.tsjustify-center tailwind.config.tspt-1 tailwind.config.tsrelative tailwind.config.tsitems-center",
        caption_label: "tailwind.config.tstext-sm tailwind.config.tsfont-medium",
        ...
        nav_button_previous: "tailwind.config.tsabsolute tailwind.config.tsleft-1",
        nav_button_next: "tailwind.config.tsabsolute tailwind.config.tsright-1",
        table: "tailwind.config.tsw-full tailwind.config.tsborder-collapse tailwind.config.tsspace-y-1",
        ...
        day_today: "tailwind.config.tsbg-accent tailwind.config.tstext-accent-foreground",
        day_outside:
        ...
        day_disabled: "tailwind.config.tstext-muted-foreground tailwind.config.tsopacity-50",
        day_range_middle:
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft className="tailwind.config.tsh-4 tailwind.config.tsw-4" />,
        IconRight: ({ ...props }) => <ChevronRight className="tailwind.config.tsh-4 tailwind.config.tsw-4" />,
      }}
      {...props}
    />
  )
